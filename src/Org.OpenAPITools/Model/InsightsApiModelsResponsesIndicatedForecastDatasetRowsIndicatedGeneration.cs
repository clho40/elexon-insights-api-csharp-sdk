...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.IndicatedForecast.DatasetRows.IndicatedGeneration")]
    public partial class InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration : IEquatable<InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration(string dataset = default(string), long? generation = default(long?), DateTime publishTime = default(DateTime), DateTime startTime = default(DateTime), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), string boundary = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration input)
        {
            if (input == null)
            {
                return false;
