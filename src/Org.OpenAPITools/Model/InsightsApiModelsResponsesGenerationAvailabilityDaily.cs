...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Generation.AvailabilityDaily")]
    public partial class InsightsApiModelsResponsesGenerationAvailabilityDaily : IEquatable<InsightsApiModelsResponsesGenerationAvailabilityDaily>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesGenerationAvailabilityDaily" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesGenerationAvailabilityDaily(string dataset = default(string), DateTime? publishTime = default(DateTime?), string fuelType = default(string), string ngcBmUnit = default(string), long? outputUsable = default(long?), DateTime forecastDate = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesGenerationAvailabilityDaily {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesGenerationAvailabilityDaily);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesGenerationAvailabilityDaily instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesGenerationAvailabilityDaily to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesGenerationAvailabilityDaily input)
        {
            if (input == null)
            {
                return false;
