...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.BidOfferAcceptancesResponse")]
    public partial class InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse : IEquatable<InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse(DateTime settlementDate = default(DateTime), int settlementPeriodFrom = default(int), int settlementPeriodTo = default(int), DateTime timeFrom = default(DateTime), DateTime timeTo = default(DateTime), int levelFrom = default(int), int levelTo = default(int), string nationalGridBmUnit = default(string), string bmUnit = default(string), int acceptanceNumber = default(int), DateTime acceptanceTime = default(DateTime), bool deemedBoFlag = default(bool), bool soFlag = default(bool), bool storFlag = default(bool), bool rrFlag = default(bool))
        {
        ...
        /// </summary>
        /// <example>2022-06-25T13:30Z</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingBidOfferAcceptancesResponse input)
        {
            if (input == null)
            {
                return false;
