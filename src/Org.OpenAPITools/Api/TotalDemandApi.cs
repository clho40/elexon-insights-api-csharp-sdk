...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface ITotalDemandApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITotalDemandApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITotalDemandApi : ITotalDemandApiSync, ITotalDemandApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TotalDemandApi : ITotalDemandApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TotalDemandApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TotalDemandApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TotalDemandApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TotalDemandApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public TotalDemandApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        public Org.OpenAPITools.Client.ApiResponse<InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyActualTotalLoadPerBiddingZone> DemandTotalActualGetWithHttpInfo(DateTime from, DateTime to, int? settlementPeriodFrom = default(int?), int? settlementPeriodTo = default(int?), string? format = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "TotalDemandApi.DemandTotalActualGet";
