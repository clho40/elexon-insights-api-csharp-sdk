...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface IActualGenerationApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IActualGenerationApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IActualGenerationApi : IActualGenerationApiSync, IActualGenerationApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ActualGenerationApi : IActualGenerationApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ActualGenerationApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ActualGenerationApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ActualGenerationApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ActualGenerationApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public ActualGenerationApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        public Org.OpenAPITools.Client.ApiResponse<List<InsightsApiModelsResponsesTransparencyAgptSummaryData>> GenerationActualPerTypeDayTotalGetWithHttpInfo(string? format = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ActualGenerationApi.GenerationActualPerTypeDayTotalGet";
        ...
        public Org.OpenAPITools.Client.ApiResponse<InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyActualGenerationBySettlementPeriod> GenerationActualPerTypeGetWithHttpInfo(DateTime from, DateTime to, int? settlementPeriodFrom = default(int?), int? settlementPeriodTo = default(int?), string? format = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ActualGenerationApi.GenerationActualPerTypeGet";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Org.OpenAPITools.Client.ApiResponse<InsightsApiModelsResponsesResponseWithMetadata1InsightsApiModelsResponsesTransparencyActualGenerationWindSolar> GenerationActualPerTypeWindAndSolarGetWithHttpInfo(DateTime from, DateTime to, int? settlementPeriodFrom = default(int?), int? settlementPeriodTo = default(int?), string? format = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ActualGenerationApi.GenerationActualPerTypeWindAndSolarGet";
            localVarRequestOptions.OperationIndex = operationIndex;
