...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.DemandForecast.DemandForecastDayAhead")]
    public partial class InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead : IEquatable<InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead(DateTime? publishTime = default(DateTime?), long transmissionSystemDemand = default(long), long? nationalDemand = default(long?), DateTime startTime = default(DateTime), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), string boundary = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesDemandForecastDemandForecastDayAhead input)
        {
            if (input == null)
            {
                return false;
