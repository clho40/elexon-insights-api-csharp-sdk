...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.Dynamic.DatasetRows.DeliveryVolumeMaxData")]
    public partial class InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData : IEquatable<InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData" /> class.
        /// </summary>
        /// <param name="dataset">dataset.</param>
        /// <param name="settlementDate">settlementDate.</param>
        /// <param name="settlementPeriod">settlementPeriod.</param>
        /// <param name="time">time.</param>
        /// <param name="volumeMax">volumeMax.</param>
        /// <param name="nationalGridBmUnit">nationalGridBmUnit.</param>
        /// <param name="bmUnit">bmUnit.</param>
        public InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData(string dataset = default(string), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), DateTime time = default(DateTime), long volumeMax = default(long), string nationalGridBmUnit = default(string), string bmUnit = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData input)
        {
            if (input == null)
            {
                return false;
