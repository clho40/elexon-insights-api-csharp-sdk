...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.Dynamic.DatasetRows.NoticeData")]
    public partial class InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData : IEquatable<InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData(string dataset = default(string), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), DateTime time = default(DateTime), int notice = default(int), string nationalGridBmUnit = default(string), string bmUnit = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData input)
        {
            if (input == null)
            {
                return false;
