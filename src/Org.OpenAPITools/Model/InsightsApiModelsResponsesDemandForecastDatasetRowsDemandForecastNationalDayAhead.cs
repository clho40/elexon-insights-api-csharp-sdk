...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.DemandForecast.DatasetRows.DemandForecastNationalDayAhead")]
    public partial class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead : IEquatable<InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead(string dataset = default(string), long? demand = default(long?), DateTime publishTime = default(DateTime), DateTime startTime = default(DateTime), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), string boundary = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead input)
        {
            if (input == null)
            {
                return false;
