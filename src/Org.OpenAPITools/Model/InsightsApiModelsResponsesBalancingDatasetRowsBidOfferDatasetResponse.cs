...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.DatasetRows.BidOfferDatasetResponse")]
    public partial class InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse : IEquatable<InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse(string dataset = default(string), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), DateTime timeFrom = default(DateTime), int levelFrom = default(int), DateTime timeTo = default(DateTime), int levelTo = default(int), int pairId = default(int), double offer = default(double), double bid = default(double), string nationalGridBmUnit = default(string), string bmUnit = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingDatasetRowsBidOfferDatasetResponse input)
        {
            if (input == null)
            {
                return false;
