...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.DemandForecast.DatasetRows.DemandForecastTransmissionDayAhead")]
    public partial class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead : IEquatable<InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead(string dataset = default(string), long? demand = default(long?), DateTime publishTime = default(DateTime), DateTime startTime = default(DateTime), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), string boundary = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead input)
        {
            if (input == null)
            {
                return false;
