...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.Physical.DatasetRows.PhysicalNotificationData")]
    public partial class InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData : IEquatable<InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData(string dataset = default(string), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), DateTime timeFrom = default(DateTime), DateTime timeTo = default(DateTime), int levelFrom = default(int), int levelTo = default(int), string nationalGridBmUnit = default(string), string bmUnit = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData input)
        {
            if (input == null)
            {
                return false;
