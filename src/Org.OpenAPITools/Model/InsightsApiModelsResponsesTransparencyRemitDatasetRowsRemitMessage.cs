...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Transparency.Remit.DatasetRows.RemitMessage")]
    public partial class InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage : IEquatable<InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage input)
        {
            if (input == null)
            {
                return false;
