...
{
    /// <summary>
    ///  Class for testing TotalDemandApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class TotalDemandApiTests : IDisposable
    {
        private TotalDemandApi instance;

        public TotalDemandApiTests()
        {
            instance = new TotalDemandApi();
        }
        ...
        /// <summary>
        /// Test an instance of TotalDemandApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' TotalDemandApi
            //Assert.IsType<TotalDemandApi>(instance);
        }
