...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.Dynamic.DatasetRows.DeliveryPeriodMinData")]
    public partial class InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData : IEquatable<InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData" /> class.
        /// </summary>
        /// <param name="dataset">dataset.</param>
        /// <param name="settlementDate">settlementDate.</param>
        /// <param name="settlementPeriod">settlementPeriod.</param>
        /// <param name="time">time.</param>
        /// <param name="periodMin">periodMin.</param>
        /// <param name="nationalGridBmUnit">nationalGridBmUnit.</param>
        /// <param name="bmUnit">bmUnit.</param>
        public InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData(string dataset = default(string), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), DateTime time = default(DateTime), int periodMin = default(int), string nationalGridBmUnit = default(string), string bmUnit = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets PeriodMin
        /// </summary>
        /// <example>360</example>
        [DataMember(Name = "periodMin", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData {\n");
            sb.Append("  Dataset: ").Append(Dataset).Append("\n");
            sb.Append("  SettlementDate: ").Append(SettlementDate).Append("\n");
            sb.Append("  SettlementPeriod: ").Append(SettlementPeriod).Append("\n");
            sb.Append("  Time: ").Append(Time).Append("\n");
            sb.Append("  PeriodMin: ").Append(PeriodMin).Append("\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PeriodMin == input.PeriodMin ||
                    this.PeriodMin.Equals(input.PeriodMin)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.PeriodMin.GetHashCode();
