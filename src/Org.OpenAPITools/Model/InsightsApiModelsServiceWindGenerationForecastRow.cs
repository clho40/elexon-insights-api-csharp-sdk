...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Service.WindGenerationForecastRow")]
    public partial class InsightsApiModelsServiceWindGenerationForecastRow : IEquatable<InsightsApiModelsServiceWindGenerationForecastRow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsServiceWindGenerationForecastRow" /> class.
        /// </summary>
        ...
        public InsightsApiModelsServiceWindGenerationForecastRow(DateTime? publishTime = default(DateTime?), DateTime startTime = default(DateTime), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), long? generation = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsServiceWindGenerationForecastRow {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsServiceWindGenerationForecastRow);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsServiceWindGenerationForecastRow instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsServiceWindGenerationForecastRow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsServiceWindGenerationForecastRow input)
        {
            if (input == null)
            {
                return false;
