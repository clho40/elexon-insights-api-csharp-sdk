...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Transparency.WeekAheadTotalLoadPerBiddingZone")]
    public partial class InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone : IEquatable<InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone(DateTime publishTime = default(DateTime), DateTime forecastDate = default(DateTime), int forecastWeek = default(int), double minimumPossible = default(double), double maximumAvailable = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesTransparencyWeekAheadTotalLoadPerBiddingZone input)
        {
            if (input == null)
            {
                return false;
