...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Balancing.DatasetRows.NetBalancingServicesAdjustmentData")]
    public partial class InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData : IEquatable<InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData(string dataset = default(string), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), double netBuyPriceCostAdjustmentEnergy = default(double), double netBuyPriceVolumeAdjustmentEnergy = default(double), double netBuyPriceVolumeAdjustmentSystem = default(double), double buyPricePriceAdjustment = default(double), double netSellPriceCostAdjustmentEnergy = default(double), double netSellPriceVolumeAdjustmentEnergy = default(double), double netSellPriceVolumeAdjustmentSystem = default(double), double sellPricePriceAdjustment = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData input)
        {
            if (input == null)
            {
                return false;
