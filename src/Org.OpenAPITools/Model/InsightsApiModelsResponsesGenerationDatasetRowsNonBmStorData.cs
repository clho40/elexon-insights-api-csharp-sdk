...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Insights.Api.Models.Responses.Generation.DatasetRows.NonBmStorData")]
    public partial class InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData : IEquatable<InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData" /> class.
        /// </summary>
        ...
        public InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData(string dataset = default(string), DateTime publishTime = default(DateTime), DateTime startTime = default(DateTime), DateTime settlementDate = default(DateTime), int settlementPeriod = default(int), long generation = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData {\n");
        ...
        {
            return this.Equals(input as InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData);
        }

        /// <summary>
        /// Returns true if InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData instances are equal
        /// </summary>
        /// <param name="input">Instance of InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData input)
        {
            if (input == null)
            {
                return false;
